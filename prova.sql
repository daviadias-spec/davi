...
-- 2 
SELECT * FROM tecnicos where turno  like ("manha");
-- 3 
SELECT * FROM maquinas where status  = "ativa" and ano_fabricacao <= 2020;
-- 4 
select * from maquinas  where tipo ="robo" or status  ="ativa";
-- 5 
select * from maquinas  where nome  like ('%2');
-- 6 
select * from maquinas  where horas_uso  between 4700 and 9100;
-- 7 
select * from maquinas  order by horas_uso desc;
-- 8
select * from maquinas  LIMIT 10;
-- 9 
select * from tecnicos where especialidade IN ('Eletrica ',' Automacao')  ;
-- 10 
SELECT * FROM manutencoes where data_manutencao > '2026-04-08' and tipo in  ('corretiva')or descricao  like ("%Substituicao%");
